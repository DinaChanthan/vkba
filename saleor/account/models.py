...
class User(PermissionsMixin, AbstractBaseUser):
    ...
    default_billing_address = models.ForeignKey(
        ...
        on_delete=models.SET_NULL)
    # <ADD
    phone_number = models.DecimalField(max_digits=30,decimal_places=0,blank=True,null=True)
    profile_image = models.ImageField(upload_to='media/profile_image',blank=True,null=True)
    # ADD>
...
class UserProfile(models.Model):
    user   = models.OneToOneField(User,on_delete=True,blank=True,null=True)
